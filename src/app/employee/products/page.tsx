...
import {AddProductStates} from "@/components/products/addProductMachine";
        ...
        <div className="p-5">
            ...
            <div className="flex flex-col gap-2 py-8">
                {data && data.map((product) => (
                    <div key={product.id} className="flex flex-row justify-between py-2.5 px-5 rounded bg-accent h-16">
                        ...
                        <div className="flex space-x-2.5">
                            ...
                            <Button size="icon" className="bg-primary h-full"><CogFour/></Button>
                            <Dialog>
                                <DialogTrigger asChild>
                                    <Button size="icon" className="bg-primary h-full"><Trash/></Button>
                                </DialogTrigger>
