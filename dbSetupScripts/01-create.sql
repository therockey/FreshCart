...
(
    "id"              INTEGER NOT NULL UNIQUE GENERATED BY DEFAULT AS IDENTITY,
    "is_greedy"       BOOLEAN,
    "point_threshold" INTEGER CHECK ( point_threshold >= 0),
...
(
    "id"          INTEGER NOT NULL UNIQUE GENERATED BY DEFAULT AS IDENTITY,
    "current_pts" INTEGER CHECK ( current_pts >= 0),
    "total_pts"   INTEGER CHECK ( total_pts >= 0),
    "money_saved" REAL CHECK ( money_saved >= 0),
